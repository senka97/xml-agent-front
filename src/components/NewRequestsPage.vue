  ...
  <div>
    ...
    <b-card no-body class="overflow-hidden shadow mb-1 mt-3 mx-5" header-bg-variant="warning">
      <template v-slot:header>
        <h2 class="sm-0 text-center"> New Requests for Your Ads </h2>
      </template>
    </b-card>
    ...
    <div  v-if="loading" align="center">
     ...
     <div v-if="!loading">
      ...
      <div v-if="!showEmpty" class="container mt-4">
...
export default {
  ...
  methods:
  {
      ...
      accept(id)
      {
          axios.put("https://localhost:8086/api/request/accept/" + id).then(
            response=> {
                ...
                this.$bvToast.toast("You have successfully accept the request. Some other requests may have been automatically rejected.", {
                  ...
                  axios.get("https://localhost:8086/api/request/pending").then(
                        response=> {
      ...
      reject(id)
      {
          axios.put("https://localhost:8086/api/request/reject/" + id).then(
            response=> {
